...
const Creator = () => {
  return (
    <>
      {/* Its a creator page i need to show 
        1) Hero secion with left hero text (any) and on right top creator on site
        2) list of creators with their image, name, and description 10
        3) each creator will have a link to their profile page
        4) each creator will have a link to their social media profiles
        5) Join us button with 
    */}
    <Header />
